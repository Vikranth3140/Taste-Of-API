...
import 'package:recipe_app/screens/France/components/franceBundleCard.dart';
          ...
          Expanded(
            child: Padding(
              ...
              child: GridView.builder(
                ...
                itemBuilder: (context, index) => FranceBundleCard(
                  franceBundle: franceBundle[index],
                  press: () {},
                ),
              )
            )
